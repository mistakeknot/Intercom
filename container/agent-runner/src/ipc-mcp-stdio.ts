...
const chatJid = process.env.INTERCOM_CHAT_JID!;
const groupFolder = process.env.INTERCOM_GROUP_FOLDER!;
const isMain = process.env.INTERCOM_IS_MAIN === '1';
